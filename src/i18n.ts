...
const resources = {
    en: {
        translation: {
            ...
            'export.summary.socialMediaTemplates_other': 'Social media templates ({{count}} files across {{platforms}} platforms)',
            ...
            'restoration.description': 'Improve image quality using AI models. Note: Processing can take up to a minute per image on slower devices.',
            'restoration.selectModel': 'Select restoration model',
            'restoration.model.deraining': 'Deraining',
            'restoration.model.dehazing_indoor': 'Indoor Dehazing',
            'restoration.model.dehazing_outdoor': 'Outdoor Dehazing',
            'restoration.model.lowlight': 'Low-Light Correction',
            'restoration.model.image-deblurring': 'Image Deblur',
    ...
    hr: {
        translation: {
            ...
            'restoration.description': 'Poboljšajte kvalitetu slike pomoću AI modela. Napomena: Obrada može potrajati i do minute po slici na sporijim uređajima.',
            'restoration.model.dehazing_indoor': 'Unutarnje odmagljivanje',
            'restoration.model.dehazing_outdoor': 'Vanjsko odmagljivanje',
            'restoration.model.lowlight': 'Poboljšanje pri slabom svjetlu',
            'restoration.model.image-deblurring': 'Uklanjanje zamućenja',
