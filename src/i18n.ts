...
const resources = {
    en: {
        translation: {
            ...
            'restoration.model.deraining': 'Deraining',
            'restoration.model.dehazing_indoor': 'Dehazing (Indoor)',
            'restoration.model.dehazing_outdoor': 'Dehazing (Outdoor)',
            'restoration.model.lowlight': 'Low-Light Enhancement',
            'restoration.model.image-deblurring': 'Deblurring',
            'restoration.model.motion-deblurring': 'Motion Deblurring',
            'restoration.model.denoising': 'Denoising',
            ...
            'restoration.desc.deraining': 'Removes rain streaks and restores detail.',
            'restoration.desc.dehazing_indoor': 'Advanced indoor scene clarification (FFA-Net).',
            'restoration.desc.dehazing_outdoor': 'Advanced outdoor scene clarification (FFA-Net).',
            'restoration.desc.lowlight': 'Enhances visibility in dark/low-light images.',
            'restoration.desc.deblurring_reds': 'Removes motion blur using REDS dataset.',
            'restoration.desc.deblurring_gopro': 'Removes motion blur using GoPro dataset.',
            'restoration.desc.denoising_sidd': 'Removes image noise using SIDD dataset.',
    ...
    hr: {
        translation: {
            ...
            'restoration.model.dehazing_indoor': 'Uklanjanje magle (Zatvoreno)',
            'restoration.model.dehazing_outdoor': 'Uklanjanje magle (Otvoreno)',
            'restoration.model.lowlight': 'Poboljšanje slabog osvjetljenja',
            'restoration.model.image-deblurring': 'Izoštravanje',
            'restoration.model.motion-deblurring': 'Uklanjanje zamućenja pokreta',
            'restoration.model.denoising': 'Uklanjanje šuma',
            'restoration.model.deraining': 'Uklanjanje kiše',
            ...
            'restoration.desc.dehazing_indoor': 'Napredno pročišćavanje unutarnjih scena (FFA-Net).',
            'restoration.desc.dehazing_outdoor': 'Napredno pročišćavanje vanjskih scena (FFA-Net).',
            'restoration.desc.lowlight': 'Osvjetljava tamne slike bez gubitka detalja.',
            'restoration.desc.deblurring_reds': 'Uklanja zamućenje pokreta koristeći REDS dataset.',
            'restoration.desc.deblurring_gopro': 'Uklanja zamućenje kretanja (GoPro).',
            'restoration.desc.denoising_sidd': 'Uklanja digitalni šum sa slika snimljenih pri visokom ISO.',
            'restoration.desc.deraining': 'Uklanja kapi kiše i vlagu sa slika.',
