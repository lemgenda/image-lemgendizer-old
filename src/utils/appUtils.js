 ...
 * @param {Array<Object>} templates - All template objects
 ...
 */
export const calculateCategoriesApplied = (selectedTemplates, templates, isFaviconSelected = false, isScreenshotSelected = false) => {
 ...
 * @param {Array<Object>} images - All image objects
 ...
 * @returns {Array<Object>} Selected images for processing
 */
export const getSelectedImagesForProcessing = (images, selectedImages, processingMode, templateSelectedImage) => {
 ...
 */
export const setupAutoClose = (closeModal, type) => {
    let timeoutRef = null;
    let timeoutDuration;
 ...
 */
export const getImageDimensions = (file, isTIFF, isSVG) => {
