...
export const generateFaviconSet = async (
    imageFile,
    siteName = DEFAULT_FAVICON_SITE_NAME,
    themeColor = DEFAULT_FAVICON_THEME_COLOR,
    backgroundColor = DEFAULT_FAVICON_BACKGROUND_COLOR,
    mode = 'complete'
) => {
    const zip = new JSZip();
 ...
 */
export const generateFaviconPreview = async (imageFile, backgroundColor = DEFAULT_FAVICON_BACKGROUND_COLOR) => {
    const img = new Image();
    const objectUrl = URL.createObjectURL(imageFile);
 ...
 */
export const getFaviconFileCount = () => {
 ...
 */
export const getFaviconFolderName = () => {
