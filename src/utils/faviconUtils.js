 ...
 */
export const generateFaviconSet = async (imageFile, siteName = DEFAULT_FAVICON_SITE_NAME) => {
    const zip = new JSZip();
    ...
    const manifest = {
        ...
        "theme_color": DEFAULT_FAVICON_THEME_COLOR,
        "background_color": DEFAULT_FAVICON_BACKGROUND_COLOR,
        "display": "standalone"
    };
...
- Make sure all paths are correct for your website structure`;
    ...
    simpleIcoCtx.fillStyle = DEFAULT_FAVICON_BACKGROUND_COLOR;
